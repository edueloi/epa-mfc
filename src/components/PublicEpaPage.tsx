...
export const PublicEpaPage: React.FC<PublicEpaPageProps> = ({ onStartSurvey, onGoToAttendance, onOpenQrCode }) => {
  return (
    <div className="space-y-12 pb-16">
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 text-white p-8 sm:p-12 lg:p-16 shadow-2xl border border-slate-800">
        ...
        <div className="relative z-10 max-w-3xl space-y-6">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/20 text-blue-300 border border-blue-500/30 text-xs font-semibold tracking-wide uppercase"
          >
          ...
          >
            5º EPA em <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-200">Pirassununga</span>
          </motion.h1>
          ...
          >
            Seja bem-vindo ao portal do 5º Encontro Paulista e Formativo do MFC.
          ...
          <motion.div 
            ...
            className="flex flex-wrap items-center gap-4 text-xs sm:text-sm text-blue-200 pt-2"
          >
          ...
          >
            <button
              ...
              className="px-6 py-4 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-400 text-white font-extrabold text-sm sm:text-base shadow-xl shadow-blue-500/25 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              className="px-5 py-4 rounded-xl bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-200 border border-indigo-500/40 font-bold text-sm transition-all flex items-center justify-center gap-2"
            >
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-8 sm:p-12 text-white shadow-xl text-center space-y-6">
        ...
        <div>
          <button
            onClick={onStartSurvey}
            className="px-8 py-4 bg-white text-blue-900 font-extrabold text-base rounded-2xl shadow-lg hover:bg-blue-50 hover:scale-105 active:scale-95 transition-all inline-flex items-center gap-2"
          >
