...
async function initTables(database: Pool) {
  ...
  await database.query(`
    CREATE TABLE IF NOT EXISTS surveys (
      ...
      workshop1_content_rating INT DEFAULT NULL,
      workshop1_didactic_rating INT DEFAULT NULL,
      workshop1_material_rating INT DEFAULT NULL,
      workshop1_interaction_rating INT DEFAULT NULL,
      workshop1_applicability_rating INT DEFAULT NULL,
      workshop1_comment TEXT,
      workshop2_id INT,
      workshop2_rating INT DEFAULT NULL,
      workshop2_content_rating INT DEFAULT NULL,
      workshop2_didactic_rating INT DEFAULT NULL,
      workshop2_material_rating INT DEFAULT NULL,
      workshop2_interaction_rating INT DEFAULT NULL,
      workshop2_applicability_rating INT DEFAULT NULL,
      workshop2_comment TEXT,
  ...
  const surveyColumnsToAdd = [
    ...
    { name: 'workshop1_content_rating', ddl: 'ADD COLUMN workshop1_content_rating INT DEFAULT NULL' },
    { name: 'workshop1_didactic_rating', ddl: 'ADD COLUMN workshop1_didactic_rating INT DEFAULT NULL' },
    { name: 'workshop1_material_rating', ddl: 'ADD COLUMN workshop1_material_rating INT DEFAULT NULL' },
    { name: 'workshop1_interaction_rating', ddl: 'ADD COLUMN workshop1_interaction_rating INT DEFAULT NULL' },
    { name: 'workshop1_applicability_rating', ddl: 'ADD COLUMN workshop1_applicability_rating INT DEFAULT NULL' },
    { name: 'workshop1_comment', ddl: 'ADD COLUMN workshop1_comment TEXT' },
    { name: 'workshop2_content_rating', ddl: 'ADD COLUMN workshop2_content_rating INT DEFAULT NULL' },
    { name: 'workshop2_didactic_rating', ddl: 'ADD COLUMN workshop2_didactic_rating INT DEFAULT NULL' },
    { name: 'workshop2_material_rating', ddl: 'ADD COLUMN workshop2_material_rating INT DEFAULT NULL' },
    { name: 'workshop2_interaction_rating', ddl: 'ADD COLUMN workshop2_interaction_rating INT DEFAULT NULL' },
    { name: 'workshop2_applicability_rating', ddl: 'ADD COLUMN workshop2_applicability_rating INT DEFAULT NULL' },
    { name: 'workshop2_comment', ddl: 'ADD COLUMN workshop2_comment TEXT' },
  ];
